#https://alpynepyano.github.io/healthyNumerics/posts/cfd-01-rectangular-grid-genereation-python.html
...
def main():
    ...
    con = sqlite3.connect(PathName+'.db')
...
# In order to formaly run the programm
